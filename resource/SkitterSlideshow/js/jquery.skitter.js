		...
		setup: function() 
		{
			...
			else 
			{
				...
				switch (self.settings.numbers_align) {
					...
					case 'centerBottom' : 
						var _vleft = (self.settings.width_skitter - self.box_skitter.find(class_info).width()) / 2;
						self.box_skitter.find(class_info).css({'left':_vleft, 'bottom': '15px', 'top':'auto'});
						break;
						
					case 'rightBottom' : 
						self.box_skitter.find(class_info).css({'left':'auto', 'right':'15px', 'bottom': '15px', 'top':'auto'});
						break;				
						
					case 'leftBottom' : 
						var _vleft = (self.settings.width_skitter - self.box_skitter.find(class_info).width()) / 2;
						self.box_skitter.find(class_info).css({'left':'15px', 'bottom': '15px', 'top':'auto'});
						break;				
				}
